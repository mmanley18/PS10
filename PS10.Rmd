...
train %>%
  mutate(log_price_doc_hat = log_price_doc_hat) %>%
  summarise(RMSLE = mean((log_price_doc - log_price_doc_hat)^2))
...
# RMSLE for predicted on train
train %>%
  mutate(log_price_doc_hat = y_hat) %>%
  summarise(RMSLE = mean((log_price_doc - log_price_doc_hat)^2))
...
--------------------- | -------------   | -------------
lm                    |  0.06424732     |  2.63413
LASSO crossvalidated  |  0.2933529      |  0.45162
